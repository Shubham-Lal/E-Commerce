...
app.get('/demo/admin', controller.demoAdmin)
app.get('/demo/user', controller.demoUser)
...
app.get('/sessions', verifyToken, controller.fetchSessions)
app.get('/payment', controller.processPayment)
